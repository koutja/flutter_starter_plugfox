...
import 'package:starter/src/initialization/platform/platform_initialization.dart' as platform_initialization;
        ...
        .logEvent(
          ...
          parameters: <String, String>{
            ...
            'app_launched_timestamp': metadata.appLaunchedTimestamp
                .toIso8601String(),
            'device_screen_size': metadata.deviceScreenSize.toString(),
